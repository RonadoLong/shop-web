...
type GinJWTMiddleware struct {
	...
	Authenticator func(loginParam interface{}, c *gin.Context) (*model.User, bool)
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	user, ok := mw.Authenticator(login, c)
	...
	if mw.PayloadFunc != nil {
		for key, value := range mw.PayloadFunc(login.Username) {
			claims[key] = value
		}
	}
